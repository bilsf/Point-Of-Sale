            ...
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            @if ($transaksis < 1)
                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Belum Ada Transaksi</p>
                            @else
                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Trasnsaksi Terdata</p>
                            @endif
                            <h5 class="font-weight-bolder">
                                {{ $transaksis }}
                            </h5>
                            ...
                            @elseif ($n->stok == 0)
                                <div class="col-12">
                                    <div class="mx-3 my-2 px-2 py-1 bg-danger rounded row">
                                        ...
                                        <div class="col-10">
                                            <h6 class="text-black m-0">Stok barang {{ $n->nama_barang }} sudah habis!</h6>
                                        </div>
                                    </div>
                                </div>
                            @endif
