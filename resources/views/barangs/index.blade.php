        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
            <div class="card z-index-2 h-100">
                <div class="card-header pb-0 pt-3 bg-transparent row">
                    ...
                    <a class="ms-2 btn btn-success w-auto me-2" href="{{ route('barangs.create') }}">Create</a>
                    <div class="dropdown w-auto">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('barangs.export-excel') }}">Excel</a></li>
                            <li><a class="dropdown-item" href="{{ route('barangs.export-pdf') }}">PDF</a></li>
                        </ul>
                    </div>
                </div>
                <div class="container">
