...
class TransaksiController extends Controller
{
    ...
    {
        $trans = Transaksi::where('id', $transaksi)->groupBy('id', 'nama_barang', 'harga_barang', 'total_barang', 'petugas', 'tgl_beli', 'created_at', 'updated_at')->get();
    ...
    public function payCart(Request $request)
    {
        ...
        foreach ($cartItems as $item) {
            ...
            // Periksa apakah $stok tidak null dan memiliki properti 'stok'
            if (!$stok || is_null($stok->stok)) {
                Alert::toast('Stok Tidak Tersedia!', 'error');
                return redirect()->back();
            }
